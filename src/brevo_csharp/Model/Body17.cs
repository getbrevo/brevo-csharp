...
namespace brevo_csharp.Model
{
    ...
    public partial class Body17 :  IEquatable<Body17>
    {
        ...
        public Body17(string visitorId = default(string), string text = default(string), string agentId = default(string), string groupId = default(string))
        {
            // to ensure "visitorId" is required (not null)
            if (visitorId == null)
            {
                throw new InvalidDataException("visitorId is a required property for Body17 and cannot be null");
            }
            else
            {
            ...
            if (text == null)
            {
                throw new InvalidDataException("text is a required property for Body17 and cannot be null");
            }
            else
            {
                this.Text = text;
