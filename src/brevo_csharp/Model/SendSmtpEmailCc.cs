...
namespace brevo_csharp.Model
{
    ...
    public partial class SendSmtpEmailCc :  IEquatable<SendSmtpEmailCc>
    {
        ...
        public SendSmtpEmailCc(string email = default(string), string name = default(string), bool? contactPixelTrackingConsent = default(bool?))
        {
