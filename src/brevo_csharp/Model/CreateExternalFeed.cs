...
namespace brevo_csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateExternalFeed :  IEquatable<CreateExternalFeed>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateExternalFeed" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateExternalFeed() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateExternalFeed" /> class.
        /// </summary>
        /// <param name="name">Name of the feed (required).</param>
        /// <param name="url">URL of the feed (required).</param>
        /// <param name="authType">Auth type of the feed:   * &#x60;basic&#x60;   * &#x60;token&#x60;   * &#x60;noAuth&#x60;  (default to AuthTypeEnum.NoAuth).</param>
        ...
        public CreateExternalFeed(string name = default(string), string url = default(string), AuthTypeEnum? authType = AuthTypeEnum.NoAuth, string username = default(string), string password = default(string), string token = default(string), List<GetExternalFeedByUUIDHeaders> headers = default(List<GetExternalFeedByUUIDHeaders>), int? maxRetries = default(int?), bool? cache = false)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for CreateExternalFeed and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (url == null)
            {
                throw new InvalidDataException("url is a required property for CreateExternalFeed and cannot be null");
            }
            else
            {
                this.Url = url;
            ...
            if (authType == null)
            {
                this.AuthType = AuthTypeEnum.NoAuth;
            }
            else
            {
        ...
        {
            return this.Equals(input as CreateExternalFeed);
        }

        /// <summary>
        /// Returns true if CreateExternalFeed instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateExternalFeed to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateExternalFeed input)
        {
            if (input == null)
                return false;
