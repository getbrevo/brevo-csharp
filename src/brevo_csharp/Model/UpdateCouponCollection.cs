...
namespace brevo_csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateCouponCollection :  IEquatable<UpdateCouponCollection>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateCouponCollection" /> class.
        /// </summary>
        /// <param name="defaultCoupon">A default coupon to be used in case there are no coupons left.</param>
        ...
        public UpdateCouponCollection(string defaultCoupon = default(string), DateTime? expirationDate = default(DateTime?), int? remainingDaysAlert = default(int?), int? remainingCouponsAlert = default(int?))
        {
        ...
        /// </summary>
        /// <value>A default coupon to be used in case there are no coupons left</value>
        ...
        {
            return this.Equals(input as UpdateCouponCollection);
        }

        /// <summary>
        /// Returns true if UpdateCouponCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateCouponCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateCouponCollection input)
        {
            if (input == null)
                return false;
