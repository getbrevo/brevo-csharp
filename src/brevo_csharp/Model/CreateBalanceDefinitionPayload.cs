...
namespace brevo_csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateBalanceDefinitionPayload :  IEquatable<CreateBalanceDefinitionPayload>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Defines rounding strategy for credit transactions.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// </summary>
        /// <value>Defines rounding strategy for debit transactions.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateBalanceDefinitionPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateBalanceDefinitionPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateBalanceDefinitionPayload" /> class.
        /// </summary>
        ...
        /// <param name="balanceExpirationDate">Fixed expiration date (&#x60;dd/mm&#x60; format) as an alternative to duration-based expiry..</param>
        ...
        /// <param name="balanceOptionCreditRounding">Defines rounding strategy for credit transactions..</param>
        /// <param name="balanceOptionDebitRounding">Defines rounding strategy for debit transactions..</param>
        ...
        public CreateBalanceDefinitionPayload(BalanceAvailabilityDurationModifierEnum? balanceAvailabilityDurationModifier = default(BalanceAvailabilityDurationModifierEnum?), BalanceAvailabilityDurationUnitEnum? balanceAvailabilityDurationUnit = default(BalanceAvailabilityDurationUnitEnum?), int? balanceAvailabilityDurationValue = default(int?), DateTime? balanceExpirationDate = default(DateTime?), BalanceOptionAmountOvertakingStrategyEnum? balanceOptionAmountOvertakingStrategy = default(BalanceOptionAmountOvertakingStrategyEnum?), BalanceOptionCreditRoundingEnum? balanceOptionCreditRounding = default(BalanceOptionCreditRoundingEnum?), BalanceOptionDebitRoundingEnum? balanceOptionDebitRounding = default(BalanceOptionDebitRoundingEnum?), string description = default(string), string imageRef = default(string), decimal? maxAmount = default(decimal?), decimal? maxCreditAmountLimit = default(decimal?), decimal? maxDebitAmountLimit = default(decimal?), Object meta = default(Object), decimal? minAmount = default(decimal?), string name = default(string), UnitEnum unit = default(UnitEnum))
        {
            ...
            if (unit == null)
            {
                throw new InvalidDataException("unit is a required property for CreateBalanceDefinitionPayload and cannot be null");
            }
            else
            {
                this.Unit = unit;
        ...
        /// </summary>
        /// <value>Fixed expiration date (&#x60;dd/mm&#x60; format) as an alternative to duration-based expiry.</value>
        ...
        {
            return this.Equals(input as CreateBalanceDefinitionPayload);
        }

        /// <summary>
        /// Returns true if CreateBalanceDefinitionPayload instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateBalanceDefinitionPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateBalanceDefinitionPayload input)
        {
            if (input == null)
                return false;
