...
namespace brevo_csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderIdentifiers :  IEquatable<OrderIdentifiers>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderIdentifiers" /> class.
        /// </summary>
        ...
        /// </summary>
        /// <value>ext_id associated with the order</value>
        ...
        /// </summary>
        /// <value>loyalty_subscription_id associated with the order</value>
        ...
        {
            return this.Equals(input as OrderIdentifiers);
        }

        /// <summary>
        /// Returns true if OrderIdentifiers instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderIdentifiers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderIdentifiers input)
        {
            if (input == null)
                return false;
