...
namespace brevo_csharp.Model
{
    ...
    public partial class Body13 :  IEquatable<Body13>
    {
        ...
        /// <param name="agentId">agent ID. It can be found on agent’s page or received &lt;a href&#x3D;\&quot;https://developers.brevo.com/docs/conversations-webhooks\&quot;&gt;from a webhook&lt;/a&gt;. Optional if &#x60;groupId&#x60; is set..</param>
        /// <param name="groupId">group ID. It can be found on group’s page. Optional if &#x60;agentId&#x60; is set..</param>
        public Body13(string visitorId = default(string), string text = default(string), string agentId = default(string), string groupId = default(string))
        {
            // to ensure "visitorId" is required (not null)
            if (visitorId == null)
            {
                throw new InvalidDataException("visitorId is a required property for Body13 and cannot be null");
            }
            else
            {
            ...
            if (text == null)
            {
                throw new InvalidDataException("text is a required property for Body13 and cannot be null");
            }
            else
            {
                this.Text = text;
        ...
        /// </summary>
        /// <value>agent ID. It can be found on agent’s page or received &lt;a href&#x3D;\&quot;https://developers.brevo.com/docs/conversations-webhooks\&quot;&gt;from a webhook&lt;/a&gt;. Optional if &#x60;groupId&#x60; is set.</value>
