...
namespace brevo_csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Otp :  IEquatable<Otp>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Otp" /> class.
        /// </summary>
        /// <param name="name">6 digit OTP received on email.</param>
        public Otp(int? name = default(int?))
        {
            this.Name = name;
        }
        ...
        /// </summary>
        /// <value>6 digit OTP received on email</value>
