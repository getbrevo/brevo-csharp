...
namespace brevo_csharp.Model
{
    ...
    public partial class InlineResponse2013 :  IEquatable<InlineResponse2013>
    {
        ...
        /// Initializes a new instance of the <see cref="InlineResponse2013" /> class.
        /// </summary>
        /// <param name="id">The id of the created collection (required).</param>
        public InlineResponse2013(string id = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for InlineResponse2013 and cannot be null");
            }
            else
            {
                this.Id = id;
        ...
        /// </summary>
        /// <value>The id of the created collection</value>
