...
namespace brevo_csharp.Model
{
    ...
    public partial class InlineResponse2008 :  IEquatable<InlineResponse2008>
    {
        ...
        /// Initializes a new instance of the <see cref="InlineResponse2008" /> class.
        /// </summary>
        /// <param name="products">List of attributed products (required).</param>
        public InlineResponse2008(List<ConversionSourceProduct> products = default(List<ConversionSourceProduct>))
        {
            // to ensure "products" is required (not null)
            if (products == null)
            {
                throw new InvalidDataException("products is a required property for InlineResponse2008 and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>List of attributed products</value>
        [DataMember(Name="products", EmitDefaultValue=false)]
        public List<ConversionSourceProduct> Products { get; set; }
