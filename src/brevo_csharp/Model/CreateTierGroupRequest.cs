...
namespace brevo_csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateTierGroupRequest :  IEquatable<CreateTierGroupRequest>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateTierGroupRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateTierGroupRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateTierGroupRequest" /> class.
        /// </summary>
        ...
        public CreateTierGroupRequest(string name = default(string), UpgradeStrategyEnum? upgradeStrategy = UpgradeStrategyEnum.Realtime, DowngradeStrategyEnum? downgradeStrategy = DowngradeStrategyEnum.Realtime, List<string> tierOrder = default(List<string>))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for CreateTierGroupRequest and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            return this.Equals(input as CreateTierGroupRequest);
        }

        /// <summary>
        /// Returns true if CreateTierGroupRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateTierGroupRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateTierGroupRequest input)
        {
            if (input == null)
                return false;
