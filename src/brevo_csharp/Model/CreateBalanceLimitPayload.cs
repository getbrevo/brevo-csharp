...
namespace brevo_csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateBalanceLimitPayload :  IEquatable<CreateBalanceLimitPayload>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateBalanceLimitPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateBalanceLimitPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateBalanceLimitPayload" /> class.
        /// </summary>
        ...
        public CreateBalanceLimitPayload(ConstraintTypeEnum constraintType = default(ConstraintTypeEnum), DurationUnitEnum durationUnit = default(DurationUnitEnum), int? durationValue = default(int?), bool? slidingSchedule = default(bool?), TransactionTypeEnum transactionType = default(TransactionTypeEnum), int? value = default(int?))
        {
            // to ensure "constraintType" is required (not null)
            if (constraintType == null)
            {
                throw new InvalidDataException("constraintType is a required property for CreateBalanceLimitPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("durationUnit is a required property for CreateBalanceLimitPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("durationValue is a required property for CreateBalanceLimitPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("transactionType is a required property for CreateBalanceLimitPayload and cannot be null");
            }
            else
            {
            ...
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for CreateBalanceLimitPayload and cannot be null");
            }
            else
            {
                this.Value = value;
        ...
        {
            return this.Equals(input as CreateBalanceLimitPayload);
        }

        /// <summary>
        /// Returns true if CreateBalanceLimitPayload instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateBalanceLimitPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateBalanceLimitPayload input)
        {
            if (input == null)
                return false;
