...
namespace brevo_csharp.Model
{
    ...
    public partial class InlineResponse2009 :  IEquatable<InlineResponse2009>
    {
        ...
        /// <param name="defaultCoupon">The default coupon of the collection.</param>
        public InlineResponse2009(string id = default(string), string name = default(string), string defaultCoupon = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for InlineResponse2009 and cannot be null");
            }
            else
            {
                this.Id = id;
